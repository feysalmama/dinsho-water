                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-white mb-0">09.00 am to 11.00 am</p>
                            </div>
                            <div class="mb-3">
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Dinsho Spring Water</a>, All right reserved.</span>
                    </div>
                    <div class="col-md-6 text-center text-md-end text-body">
                        Designed By <a class="border-bottom text-white" href="https://parfonet-tech.com">PerfoNet ICT Solution</a>
                    </div>
                </div>
            </div>
        </div>
