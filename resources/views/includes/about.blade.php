                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-img rounded h-100">
                            <img src="{{asset("img/about-us.jpg")}}" class="img-fluid rounded h-100 w-100" style="object-fit: cover;" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="about-item">
                            ...
                            <a href="{{route("about")}}" class="btn btns-color rounded-pill py-3 px-5">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
